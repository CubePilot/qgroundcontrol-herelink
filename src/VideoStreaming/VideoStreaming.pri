...
LinuxBuild {
    ...
    #- gstreamer assumed to be installed in $$PWD/../../gstreamer-1.0-android-universal-1.20.3/***
    contains(QT_ARCH, arm) {
        GST_ROOT = $$PWD/../../gstreamer-1.0-android-universal-1.20.3/armv7
    } else:contains(QT_ARCH, arm64) {
        GST_ROOT = $$PWD/../../gstreamer-1.0-android-universal-1.20.3/arm64
    } else {
        GST_ROOT = $$PWD/../../gstreamer-1.0-android-universal-1.20.3/x86
    }
