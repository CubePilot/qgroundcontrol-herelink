...
Item {
    ...
    property var cameraModels: [ qsTr("None"), qsTr("Q10F"), qsTr("Q10T"), qsTr("Z10TIR") , qsTr("Z40K") , qsTr("Z40TIR") , qsTr("H30T"), qsTr("Z10TIR Mini"), qsTr("NightHawk"), qsTr("DragonEye"), qsTr("Raptor")]
    Column {
        anchors.fill:       parent
