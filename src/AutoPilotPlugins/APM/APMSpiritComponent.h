...
#ifndef APMSpiritComponent_H
#define APMSpiritComponent_H

#include "VehicleComponent.h"

class APMSpiritComponent : public VehicleComponent
{
    Q_OBJECT
    
public:
    APMSpiritComponent(Vehicle* vehicle, AutoPilotPlugin* autopilot, QObject* parent = nullptr);
