...
Item {
    ...
    property bool showTakeoff:          _guidedActionsEnabled && activeVehicle.takeoffVehicleSupported && !_vehicleFlying && _canArm && (_flightMode === "Guided") // TODO: activeVehicle.guidedMode did not work
